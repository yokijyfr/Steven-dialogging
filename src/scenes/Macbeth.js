class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.FirstWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch1').setOrigin(0, 1);
        this.SecondWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch2').setOrigin(0, 1);
        this.ThirdWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'witch3').setOrigin(0, 1);
